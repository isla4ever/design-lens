...
export const messages: Record<Locale, I18nMessages> = {
  zh: {
    ...
    quickStart: "先开始录制，手动浏览、滚动、悬停页面，再结束生成设计工作台。",
    ...
    openHint: "打开任意网页后，手动录制它的动画、布局和交互节奏。",
    language: "语言",
    chinese: "中文",
    english: "English",
    lightTheme: "浅色模式",
  ...
  en: {
    ...
    primaryAction: "Record page",
    secondaryAction: "Pick component",
    quickStart: "Start recording, then browse, scroll, and hover the page before generating the design workbench.",
    pickHint: "Picking a component uses a lighter overlay to reduce blockage.",
    openPanel: "Open panel",
    opening: "Opening recorder...",
    ...
    openHint: "Open any website, then manually record its motion, layout, and interaction rhythm.",
    language: "Language",
    chinese: "中文",
    english: "English",
