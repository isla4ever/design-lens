...
| **默认打开完整侧边栏** | 点击扩展图标直接进入 Side Panel；模式、捕获、覆盖、历史和设置集中在同一工作区。紧凑视图保留快速操作，并作为旧版 Chromium 的自动兜底。 |
...
<table>
  <tr>
    <td width="46%" align="center">
      <img src="docs/assets/design-lens-popup-smart-capture.png" alt="Design Lens 紧凑视图智能捕获结果" />
    </td>
  ...
  <tr>
    <td><strong>紧凑视图</strong><br />只保留模式、智能捕获、组件选取与导出，详细要求统一放在 Side Panel。</td>
